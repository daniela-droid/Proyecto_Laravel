...
<!-- <div style="background-color:#233858; color: white; padding: 10px 20px; border-radius: 5px;">
    <h1 style="margin: 0; font-size: 1.5rem;">Docentes</h1>
</div> -->
<h4><strong>Docentes </strong><i class="fas fa-user text-navy"></i></h4>
...
<div class="container">
    @php  
        ...
        if(count($docentes)>0){
            ...
            foreach($docentes as $docente){
                $btnEdit = '<a href="' . route('docentes.edit', $docente->id) . '" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Edit">
                                <i class="fa fa-lg fa-fw fa-pen"></i>
                            </a>';
                $btnDelete = '<button class="btn btn-xs btn-default text-danger mx-1 shadow" data-toggle="modal" title="Delete" data-target="#modalDelete-'.$docente->id.'">
                                <i class="fa fa-lg fa-fw fa-trash"></i>
                            </button>';
                $btnDetails = '<a href="' . route('docentes.show', $docente->id) . '" class="btn btn-xs btn-default text-teal mx-1 shadow" title="Details">
    ...
    <div class="row">
        <div class="col">
            <hr>
            <!-- <x-adminlte-card icon="fas fa-user-graduate"  theme="lightblue" title="Listado de Docentes"> -->
