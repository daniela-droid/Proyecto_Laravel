    ...
    @php  
        ...
        if(count($admins)>0){
            ...
            foreach($admins as $admin){
                $btnEdit = '<a href="' . route('admins.edit', $admin) . '" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Edit">
                ...
                $btnDetails = '<a href="' . route('admins.show', $admin) . '" class="btn btn-xs btn-default text-teal mx-1 shadow" title="Details">
